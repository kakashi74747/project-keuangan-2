                ...
                <form method="POST" action="transactions.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="amount" id="amount_formatted" placeholder="0" value="<?= $edit_data['amount'] ?? '0'; ?>">
                        </div>
                    </div>
                    <div class="row">
...
<script>
    window.addEventListener(\'DOMContentLoaded\', event => {
        ...
        let originalAmountInput = document.createElement("input");
        originalAmountInput.type = "hidden";
        originalAmountInput.name = "amount";
        originalAmountInput.value = unformatRupiah(amountFormatted.value);
        amountFormatted.parentNode.appendChild(originalAmountInput);
        amountFormatted.name = "amount_formatted";
        ...
        function updateCategoryOptions() {
            ...
            if (selectedType === "Pemasukan" || selectedType === "Pengeluaran") {
                ...
                categorySelect.required = false; // Dibuat false agar "Tanpa Kategori" valid
        ...
        amountFormatted.value = formatRupiah(amountFormatted.value);
        amountFormatted.addEventListener(\'keyup\', function(e){
            let cleanValue = unformatRupiah(this.value);
            originalAmountInput.value = cleanValue;
