    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link <?php echo ($active_page == 'budgeting') ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>budgeting.php">Anggaran</a></li>
                ...
                <li class="nav-item"><a class="nav-link <?php echo ($active_page == 'debts') ? 'active' : ''; ?>" href="<?php echo BASE_URL; ?>debts.php">Utang/Piutang</a></li>
